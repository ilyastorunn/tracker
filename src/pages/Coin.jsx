...
export default function Coin() {
  ...
  return (
    <div className="bg-[#121212] min-h-screen py-10">
      <div className="max-w-[1200px] mx-auto px-4 bg-[#121212]">
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg">
          ...
          <div className="relative">
            ...
            />
            <button className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-800 p-2 rounded-full hover:bg-gray-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
